...
class DepthYawVisionController(Node):
    ...
    def __init__(self):
        ...
        #simulator's camera topic (delete)
        ...
        self.image_sub = self.create_subscription(Image, '/master/camera', self.image_cb, 10)
        ...
        model_path = get_package_share_directory("src") + "/best.pt"
